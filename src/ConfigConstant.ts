export const HARVESTER_MAX_COUNT: Number = 4;
export const UPGRADER_MAX_COUNT: Number = 2;
export const BUILDER_MAX_COUNT: Number = 2;
export const FILLER_MAX_COUNT: Number = 2;
export const SUPPORTER_MAX_COUNT: Number = 1;
